"""Software render of the ThruBlack window (no OpenGL). freecadcmd render_sw.py
Renders the single .FCStd in this folder to preview_iso.png, viewed from the
exterior. Vinyl reads ThruBlack; glass reads light blue-grey."""
import os, math, glob
import numpy as np
